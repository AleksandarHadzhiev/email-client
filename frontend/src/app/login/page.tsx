    ...
    return (
        <div className="w-full h-screen flex justify-center items-center align-center">
            <div className="flex flex-col w-48 space-y-6">
                ...
                <button className="bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded" onClick={() => { google() }}>Google SSO</button>
                <button className="bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded" onClick={() => { microsoft() }}>Microsoft SSO</button>
            </div>
        </div>
    )
}